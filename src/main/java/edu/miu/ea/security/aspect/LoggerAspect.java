package edu.miu.ea.security.aspect;
...
public class LoggerAspect {
    ...
    @Pointcut("@annotation(edu.miu.ea.security.aspect.annotation.LogMe)")
    ...
    @Around("execution(* edu.miu.ea.security.service.ProductService.addProduct(..))")
